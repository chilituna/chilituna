# 💫 About Me:
Student at 42 Berlin<br>Finished coding projects:<br>Rank 0<br>📚 Libft: creating my own C library that includes functions for memory manipulation, string manipulation, and linked list operations<br>Rank 1<br>✍️ ft_printf: recoding printf()<br>📖  get_next_line: creating a function to read from fd(s) line by line<br>🖥️ Born2beroot:  System Administration exercise: setting up a virtual machine with own operating system, while implementing strict rules.<br>Rank 2<br>🗄️ push_swap: creating a program for optimized data sorting <br>🎨 fract-ol: creating a program to show beautiful fractals<br>👩‍🔧 pipex: coding a program that is mimicking the pipe command | in shell<br>
